...
# 복사명령어(폴더 복사시에는 -r 옵션)
# cp 복사대상 복사될파일명
cp first_file.txt fist_file_copy.txt
...
# 타입은 file인 파일중에서  이름이 first 로 시작하는 파일을 찾아, 그 파일들 안에 hello라는 키워드가 들어가 있는 문장 찾아라.
